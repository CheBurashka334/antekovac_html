...
<div class="container">
	<ul class="breadcrumbs">
		...
		<li class="breadcrumbs__item"><a href="#">Статьи</a></li>
		<li class="breadcrumbs__item breadcrumbs__item--unactive"><a href="#">Название статьи</a></li>
	</ul>
</div>
<div class="container page--article">
	<div class="grid-equalHeight">
		...
		<div class="col-8_sm-12">
			<div class="tile-block tile-block--scrollable mobile-fullwidth">
				<div class="tile-block__heading tile-block__heading--date">
					<h2>название статьи</h2>
					<div class="tile-block__note news__date">12 марта 2016 г.</div>
				</div>
				<div class="tile-block__content js-scrollable-content" data-height="27em">
	...
	<div class="heading"><h2>Читать другие статьи</h2></div>
