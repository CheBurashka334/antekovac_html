			...
			<div class="product-detail__info tile-block tile-block--bordered--no-mobile no-margin js-anim-scroll">
				...
				<div class="tile-block__wrapper grid-column-noGutter">
					...
					<div class="tile-block--bordered--mobile">
						<div class="product-detail__desc js-scrollable-content" data-height="13em">
							<p>
								Славянка тихая, сколь ток приятен твой,<br>
								Когда, в осенний день, в твои глядятся воды<br>
								Холмы, одетые последнею красой<br>
								Полуотцветшия природы.<br>
								<br>
								В.А. Жуковский<br>
								<br>
								Арт-объект вдохновлен ощущением русской осени. Теплые насыщенные красно-оранжевые оттенки кожи ассоциируются с кленовой листвой,&nbsp;&nbsp;а корпус изделия из коричневой замши символизирует плодородную почву. Крышка клатча, выполненная в форме матрешки, благодаря художественному оформлению символично выражает собой образ урожайности.<br></br>
								Это единственное изделие коллекции «Славянка» выполненное сприменением замши. На создание модели направлена сила дизайнерской и конструкторской мысли, каждая из которых взаимоувязана в гармонии для получения продукта высочайшего качества и уровня дизайна. Основа данного клатча выполнена в характерном стиле коллекции модульного пошива. Сочетание бархатной замши и блеска телячьей кожи специальной обработки создает оригинальный контраст. Крышка клатча выступает в роли цельного клапана как для основного отделения, так и для заднего кармана, который закрывается на молнию. Внутри основы тканевая подкладка&nbsp;&nbsp;и карман. Длинный ремень съемный и входит в комплект.</br></br>
							</p>
						</div>
