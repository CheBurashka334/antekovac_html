<div class="horizontal-menu mobile-fullwidth dropdown--mobile">
	...
	<div class="horizontal-menu__list grid-noGutter dropdown__list">
		...
		<div class="horizontal-menu__item col dropdown__item">
			<a href="lk_favorite.php" class="horizontal-menu__link dropdown__title">Отложенные товары</a>
		</div>
		<div class="horizontal-menu__item col dropdown__item">
			<a href="lk_profile.php" class="horizontal-menu__link dropdown__title">персональные данные</a>
		</div>
		<div class="horizontal-menu__item col dropdown__item">
			<a href="#" class="horizontal-menu__link dropdown__title">безопасность</a>
		</div>
	</div>
</div>